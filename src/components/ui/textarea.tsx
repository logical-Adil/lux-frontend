    ...
    return (
      <textarea
        className={cn(
          ...
          "flex min-h-[80px] w-full border border-input bg-background px-3 rounded-xs py-2 text-sm text-foreground ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none  disabled:cursor-not-allowed disabled:opacity-50",
          className
        )}
        ref={ref}
        {...props}
