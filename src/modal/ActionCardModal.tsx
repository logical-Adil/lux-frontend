...
const ActionCardModal = () => {
  ...
  return (
    <div>
      ...
      >
        <div
          className="text-white flex flex-col justify-center p-12 w-full  min-h-[230px] overflow-hidden"
          style={modalStyle}
        >
          {paymentSuccess ? (
            // ✅ Success Content
              ...
              <div className="overflow-hidden" ref={emblaRef}>
                <div className="flex">
                  ...
                  <div className="flex-[0_0_100%] flex flex-col space-y-10">
                    ...
                    <button className="w-full max-w-[92%] mx-auto py-[6px] text-[10px] text-white bg-[var(--theme-color)] hover:bg-[var(--theme-hover-color)] rounded-[5px] cursor-pointer">
                      Load Card
                    </button>
                    <button className="w-full max-w-[92%] mx-auto py-[6px] text-[10px] text-white bg-[var(--theme-color)] hover:bg-[var(--theme-hover-color)] rounded-[5px] cursor-pointer">
                      Request Pin
